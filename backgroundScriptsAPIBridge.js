...
class EdgeChromeAlarmBridge {
    get onAlarm() {
        return bridgeLog.DoActionAndLog(
            ...
            'alarms.onAlarm',
            undefined,
            'bridgeHelper.alarms.onAlarm'
        );
    }
    create(name, alarmInfo) {
        bridgeLog.DoActionAndLog(
            () => {
                bridgeHelper.alarms.create.apply(
                    bridgeHelper.alarms,
                    arguments
                );
            },
            'alarms.create',
            undefined,
            'bridgeHelper.alarms.create'
        );
    }
    getAll(callback) {
        bridgeLog.DoActionAndLog(
            () => {
                bridgeHelper.alarms.getAll.apply(
                    bridgeHelper.alarms,
                    arguments
                );
            },
            'alarms.getAll',
            undefined,
            'bridgeHelper.alarms.getAll'
        );
    }
    clearAll(callback) {
        bridgeLog.DoActionAndLog(
            () => {
                bridgeHelper.alarms.clearAll.apply(
                    bridgeHelper.alarms,
                    arguments
                );
            },
...
class EdgeChromeAppBridge {
    getDetails() {
        return bridgeLog.DoActionAndLog(
            () => {
                return EdgeChromeRuntimeBridge.prototype.getManifest.apply(
                    null,
                    arguments
                );
            },
...
class EdgeChromeBookmarksBridge extends EdgeBookmarksBridge {
    get onRemoved() {
        bridgeLog.LogUnavailbleApi('bookmarks.onRemoved');
        return bridgeHelper.fakeEvent;
    }
    get onImportEnded() {
        bridgeLog.LogUnavailbleApi('bookmarks.onImportEnded');
        return bridgeHelper.fakeEvent;
    }
    get onImportBegan() {
        bridgeLog.LogUnavailbleApi('bookmarks.onImportBegan');
        return bridgeHelper.fakeEvent;
    }
    get onChanged() {
        bridgeLog.LogUnavailbleApi('bookmarks.onChanged');
        return bridgeHelper.fakeEvent;
    }
    get onMoved() {
        bridgeLog.LogUnavailbleApi('bookmarks.onMoved');
        return bridgeHelper.fakeEvent;
    }
    get onCreated() {
        bridgeLog.LogUnavailbleApi('bookmarks.onCreated');
        return bridgeHelper.fakeEvent;
    }
    get onChildrenReordered() {
        bridgeLog.LogUnavailbleApi('bookmarks.onChildrenReordered');
        return bridgeHelper.fakeEvent;
    }
...
class EdgeBrowserActionBridge {
    ...
    getBadgeBackgroundColor(details, callback) {
        bridgeLog.DoActionAndLog(() => {
            myBrowser.browserAction.getBadgeBackgroundColor.apply(
                null,
                arguments
            );
    ...
    setBadgeBackgroundColor(details) {
        bridgeLog.DoActionAndLog(() => {
            myBrowser.browserAction.setBadgeBackgroundColor.apply(
                null,
                arguments
            );
...
class EdgeChromeCommandsBridge {
    get onCommand() {
        bridgeLog.LogUnavailbleApi('commands.onCommand');
        return bridgeHelper.fakeEvent;
    }
    getAll(callback) {
...
class EdgeChromeIdleBridge {
    get onStateChanged() {
        bridgeLog.LogUnavailbleApi('idle.onStateChanged');
        return bridgeHelper.fakeEvent;
    }
...
class EdgeNotificationBridge {
    get onButtonClicked() {
        return bridgeLog.DoActionAndLog(() => {
            return myBrowser.notifications.onButtonClicked;
        }, 'notifications.onButtonClicked');
    }
    get onClicked() {
        return bridgeLog.DoActionAndLog(() => {
            return myBrowser.notifications.onClicked;
        }, 'notifications.onClicked');
    }
    get onClosed() {
        return bridgeLog.DoActionAndLog(() => {
            return myBrowser.notifications.onClosed;
        }, 'notifications.onClosed');
    }
    get onPermissionLevelChanged() {
        return bridgeLog.DoActionAndLog(() => {
            return myBrowser.notifications.onPermissionLevelChanged;
...
class EdgeTabsBridge {
    ...
    get onAttached() {
        return bridgeLog.DoActionAndLog(() => {
            return myBrowser.tabs.onAttached;
        }, 'tabs.onAttached');
    }
    get onCreated() {
        return bridgeLog.DoActionAndLog(() => {
    ...
    get onDetached() {
        return bridgeLog.DoActionAndLog(() => {
            return myBrowser.tabs.onDetached;
        }, 'tabs.onDetached');
    }
    get onRemoved() {
        return bridgeLog.DoActionAndLog(() => {
    ...
    update(tabId, updateProperties, callback) {
        ...
        for (var index = 0; index < arguments.length; index++) {
            ...
            if (typeof argument === 'object') {
                if (
                    !argument.active &&
                    (argument.highlighted || argument.selected)
                ) {
        ...
        bridgeLog.DoActionAndLog(
            ...
            'tabs.update',
            undefined,
            updatePropertiesBridged
                ? 'tabs.update with UpdateProperties modified'
                : undefined
        );
    }
}
class EdgeChromeTabsBridge extends EdgeTabsBridge {
    ...
    getAllInWindow(windowId, callback) {
        bridgeLog.DoActionAndLog(
            () => {
                EdgeTabsBridge.prototype.query(
                    { windowId: windowId },
                    callback
                );
            },
    ...
    getSelected(windowId, callback) {
        bridgeLog.DoActionAndLog(
            () => {
                EdgeTabsBridge.prototype.query({ active: true }, (tabs) =>
                    callback(tabs[0])
                );
            },
            'tabs.getSelected',
    ...
    constructor() {
        ...
        this.bookmarks =
            typeof browser['bookmarks'] !== 'undefined'
                ? new EdgeChromeBookmarksBridge()
                : undefined;
        this.browserAction =
            typeof browser.browserAction !== 'undefined'
                ? new EdgeChromeBrowserActionBridge()
                : undefined;
        this.contextMenus =
            typeof browser.contextMenus !== 'undefined'
                ? new EdgeContextMenusBridge()
                : undefined;
        this.cookies =
            typeof browser.cookies !== 'undefined'
                ? new EdgeChromeCookiesBridge()
                : undefined;
        this.extension =
            typeof browser.extension !== 'undefined'
                ...
                : undefined;
        this.history =
            typeof browser.history !== 'undefined'
                ? new EdgeHistoryBridge()
                : undefined;
        this.i18n =
            typeof browser.i18n !== 'undefined'
                ...
                : undefined;
        this.pageAction =
            typeof browser.pageAction !== 'undefined'
                ? new EdgePageActionBridge()
                : undefined;
        this.permissions =
            typeof browser.permissions !== 'undefined'
                ? new EdgePermissionsBridge()
                : undefined;
        this.runtime =
